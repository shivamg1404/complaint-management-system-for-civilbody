...
<select name="complaintype" class="form-control" required="">
                <option value=" Complaint"> Complaint</option>
                  <option value="General Query">General Complaint.</option>
                  <option value="General Query">Emergency Complaint.</option>
                </select> 
</div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Name of Complaint</label>
<div class="col-sm-4">
